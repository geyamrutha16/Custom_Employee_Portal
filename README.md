...
cd backend
cp .env.example .env # fill in DB\_\* and a real JWT_SECRET
npm install
npm run migrate
...
cd backend
cp .env.example .env # fill in DB\_\* and JWT_SECRET
npm install
npm run migrate
npm run seed
